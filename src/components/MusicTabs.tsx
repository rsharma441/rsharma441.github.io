...
const MusicTabs: React.FC<MusicTabProps> = ({ recommendations, answers, setAnswers }) => {
  ...
  const renderLoadingOrError = () => {
    ...
    if (!albums && location.pathname === "/albums") return <p>No albums found.</p>;
...
>
  Extras
      ...
      <div>
        ...
        <Routes>
          <Route path="albums" element={albums ? <AlbumList albums={albums} recommendations={recommendations} /> : null} />
          <Route path="songs" element={songs ? <SongList songs={songs}  /> : null} />
          <Route path="surprise" element={<Surprise answers={answers} setAnswers={setAnswers} />} />
        </Routes>
